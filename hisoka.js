...
let buttons = [
            ...
            break
case 'hentai': case 'nsfw hentai': case 'nsfwhentai': {
m.reply(mess.wait)
let buttons = [
                    {buttonId: `${prefix} hentai`, buttonText: {displayText: 'Next⏩'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api.dapuhy.xyz/api/nsfw/nsfwhentai?apikey=betakey' },
                    caption: `Jangan Sange Bro ${pushname}🙀`,
                    footer: hisoka.user.name,
                    buttons: buttons,
                    headerType: 4
                }
            ...
            break
case 'cum': case 'nsfw cum': case 'nsfwcum': {
m.reply(mess.wait)
let buttons = [
                    {buttonId: `${prefix} cum`, buttonText: {displayText: 'Next⏩'}, type: 1}
                ]
                let buttonMessage = {
                    image: { url: 'https://api.dapuhy.xyz/api/nsfw/nsfwcumarts?apikey=betakey' },
                    caption: `Jangan Sange Bro ${pushname}🙀`,
                    footer: hisoka.user.name,
                    buttons: buttons,
                    headerType: 4
